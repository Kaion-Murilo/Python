...
class Funcoes_BD():
    ...
    def alterar_BD_Com(self):
        self.pegar_dados_pessoa()  
        self.Conexao_BD()
        Comando = f"""UPDATE convidado SET nome='{self.Liv.nome}',numero={self.Liv.numero} where id ='{self.Liv.nome}'"""
        self.cursor.execute(Comando)
        self.conex_banco.commit()
        print("elemento alterado com sucesso")
        self.desconectaBD()
    ...
    def alterar_BD_Prof(self):
        self.pegar_dados_pessoa()  
        self.Conexao_BD()
        Comando = f"""UPDATE Profesor SET nome ='{self.Liv.nome}',
    ...
    def alterar_BD_Func(self):
        self.pegar_dados_pessoa()  
        self.Conexao_BD()
        Comando = f"""UPDATE funcionario SET nome ='{self.Liv.nome}',
        cpf='{self.Liv.cpf}',email='{self.Liv.email}',
        numero={self.Liv.numero},
        senha='{self.Liv.senha}',salario={self.Liv.salario}
        where cpf='{self.Liv.cpf}' """
    ...
    def Exclui_BD_alu(self):
        self.pegar_dados_pessoa()
        self.Conexao_BD()
        Comando= f"""DELETE FROM Aluno WHERE cpf='{self.Liv.cpf}'  """
        self.cursor.execute(Comando)
        self.conex_banco.commit()
        print("Elemento excluido com Sucesso!")
        self.desconectaBD()
        self.Limpar_Campos_geral()   
    def Exclui_BD_func(self):
        self.pegar_dados_pessoa()
        self.Conexao_BD()
        Comando= f"""DELETE FROM funcionario WHERE cpf='{self.Liv.cpf}'  """
        self.cursor.execute(Comando)
        self.conex_banco.commit()
        print("Elemento excluido com Sucesso!")
        self.desconectaBD()
        self.Limpar_Campos_geral()   
    def Exclui_BD_prof(self):
        self.pegar_dados_pessoa()
        self.Conexao_BD()
        Comando= f"""DELETE FROM profesor WHERE cpf='{self.Liv.cpf}'  """
        self.cursor.execute(Comando)
        self.conex_banco.commit()
        print("Elemento excluido com Sucesso!")
        self.desconectaBD()
        self.Limpar_Campos_geral()   
    def Exclui_BD_com(self):
        self.pegar_dados_pessoa()
        self.Conexao_BD()
    ...
    def Atualizar_Listagem_BD_Alu(self):
        ...
        self.Conexao_BD()
        Lista = self.cursor.execute("""SELECT id,nome,senha,
                                    idade,email,numero,cpf,"",plano
          FROM Aluno ORDER BY ID ASC;""")
        for i in Lista:
            self.tv.insert("",END,values=i)
        self.desconectaBD()
    def Atualizar_Listagem_BD_Prof(self):
        self.tv.delete(*self.tv.get_children())
        self.Conexao_BD()
        Lista = self.cursor.execute("""SELECT id, nome,numero,"",email,senha,cpf,salario,"" FROM profesor ORDER BY ID ASC;""")
        for i in Lista:
            self.tv.insert("",END,values=i)
        self.desconectaBD()
    def Atualizar_Listagem_BD_Com(self):
        self.tv.delete(*self.tv.get_children())
        self.Conexao_BD()
        Lista = self.cursor.execute("""SELECT id,nome,numero,"","","","","","" FROM Convidado ORDER BY ID ASC;""")
        for i in Lista:
            self.tv.insert("",END,values=i)
        self.desconectaBD() 
    def Atualizar_Listagem_BD_func(self):
        self.tv.delete(*self.tv.get_children())
        self.Conexao_BD()
        Lista = self.cursor.execute("""SELECT id,nome,numero,"",senha,email,CPF,salario,"" FROM Funcionario ORDER BY ID ASC;""")
        for i in Lista:
            self.tv.insert("",END,values=i)
        self.desconectaBD()
    def Cadastrar_BD_alu(self):
        self.Pega_dados_alu()
        self.Conexao_BD() 
        self.cursor.execute(f"""INSERT INTO Aluno(nome,email,numero,idade,senha,cpf,plano) VALUES 
        ('{self.Liv.nome}',{self.Liv.numero},{self.Liv.idade},{self.Liv.email},
    ...
    def Cadastrar_BD_Prof(self):
        ...
        self.Conexao_BD() 
        self.cursor.execute(f"""INSERT INTO Profesor(nome,numero,senha,email,cpf,salario) VALUES 
        ('{self.Liv.nome}',{self.Liv.numero},
    ...
    def Cadastrar_BD_func(self):
        ...
        self.Conexao_BD() 
        print("passou")
        self.cursor.execute(f"""INSERT INTO Funcionario(nome,numero,senha,email,cpf,salario) VALUES 
        ('{self.Liv.nome}',{self.Liv.numero},'{self.Liv.senha}',
    ...
    def Cadastrar_BD_Com(self):
        self.Pega_dados_Com()
        self.Conexao_BD() 
        self.cursor.execute(f"""INSERT INTO convidado(nome,numero) VALUES('{self.Liv.nome}',{self.Liv.numero}) """)
        self.conex_banco.commit();
        self.desconectaBD()
        self.Limpar_Campos_geral()
    ...
    def pegar_dados_pessoa(self):
        self.Liv = pessoa(nome=self.vnome.get() ,cpf=self.vcpf.get(),numero= self.vfone.get(),
    ...
    def clique_duplo(self, event):
        ...
        for m in self.tv.selection():
            id,nome,numero,idade,senha,email,cpf,salario,plano = self.tv.item(m,'values')
            print("gol")
...
class Interface_LocBoy(Funcoes_BD):
    ...
    def grid(self):
        self.tv=ttk.Treeview(self.Frame_2_Usuario,column=('id','nome','numero','idade','senha','email','cpf','salario','plano'),show='headings')
        ...
        self.tv.column('id',width=10)
        self.tv.column('nome',width=120)
        self.tv.column('email',width=100)
        self.tv.column('numero',width=50)
        self.tv.column('idade',width=50)
        self.tv.column('senha',width=50)
        self.tv.column('salario',width=50)
        self.tv.column('plano',width=100)
        self.tv.column('cpf',width=50)
        self.tv.place(relx=0.02, rely=0.5,relwidth=0.8 ,relheight=0.4)
        
        self.btn_inserir=Button(self.Frame_2_Usuario,text="mostrar funcionarios", )
        ...
        self.btn_dl_p=Button(self.Frame_2_Usuario,text="delete professor",command=self.Exclui_BD_prof)
        self.btn_dl_f=Button(self.Frame_2_Usuario,text="delete funcionario",command=self.Exclui_BD_func)
        self.btn_dl_c=Button(self.Frame_2_Usuario,text="delete comvidao",command=self.Exclui_BD_com)
        ...
        self.btn_al_c=Button(self.Frame_2_Usuario,text="alterae comvidado",command=self.alterar_BD_Com)
        
        
        self.btn_alu=Button(self.Frame_2_Usuario,text="alunos",command=self.Atualizar_Listagem_BD_Alu)
        self.btn_func=Button(self.Frame_2_Usuario,text="funcionaris",command=self.Atualizar_Listagem_BD_func)
        self.btn_prof=Button(self.Frame_2_Usuario,text="profesor",command=self.Atualizar_Listagem_BD_Prof)
        self.btn_com=Button(self.Frame_2_Usuario,text="comvidados",command=self.Atualizar_Listagem_BD_Com)
       
        self.iemail=Label(self.Frame_2_Usuario,text="emial",)
        self.vemail=Entry(self.Frame_2_Usuario)
        self.ibnome=Label(self.Frame_2_Usuario,text="nome",)
        self.vnome=Entry(self.Frame_2_Usuario)
        ...
        self.btn_dl_c.place(relx=0.50, rely=0.01,relwidth=0.12,relheight=0.03)
        self.btn_dl_a.place(relx=0.50, rely=0.07,relwidth=0.12,relheight=0.03)
        self.btn_dl_f.place(relx=0.50, rely=0.11,relwidth=0.12,relheight=0.03)
        self.btn_dl_p.place(relx=0.50, rely=0.15,relwidth=0.12,relheight=0.03)
        
        self.btn_deleta.place(relx=0.65, rely=0.40,relwidth=0.12,relheight=0.03)
        self.btn_func.place(relx=0.65, rely=0.10,relwidth=0.12,relheight=0.03)
        self.btn_alu.place(relx=0.65, rely=0.15,relwidth=0.12,relheight=0.03)
        self.btn_prof.place(relx=0.65, rely=0.22,relwidth=0.12,relheight=0.03)
        self.btn_com.place(relx=0.65, rely=0.33,relwidth=0.12,relheight=0.03)
        self.btn_al_a.place(relx=0.50, rely=0.17,relwidth=0.12,relheight=0.03)
        self.btn_al_c.place(relx=0.50, rely=0.25,relwidth=0.12,relheight=0.03)
        self.btn_al_p.place(relx=0.50, rely=0.30,relwidth=0.12,relheight=0.03)
        self.btn_al_f.place(relx=0.50, rely=0.35,relwidth=0.12,relheight=0.03)
        
        
        self.scrolllistagem=Scrollbar(self.Frame_2_Usuario,orient='vertical')  
        self.tv.configure(yscroll=self.scrolllistagem.set)
        self.scrolllistagem.place(relx=0.82,rely=0.50,relheight=0.4)
    ...
    def Pegar_Dados_Alunos(self):
        ...
        if (Idade_Alu_Inf > 1 and Idade_Alu_Inf < 100) and (Inf_Plano == "Plano Básico"):#and self.validacao(Cpf_Fun_Inf)==True)::
        ...
        elif (Idade_Alu_Inf > 1 and Idade_Alu_Inf < 100) and (Inf_Plano == "Plano Médio"):#and self.validacao(Cpf_Fun_Inf)==True):
            ...
            self.Idade_Alu.delete(0,END)
            self.Senha_Alu.delete(0,END)
        elif (Idade_Alu_Inf > 1 and Idade_Alu_Inf < 100) and (Inf_Plano == "Plano Completo"):#and self.validacao(Cpf_Fun_Inf)==True)::
